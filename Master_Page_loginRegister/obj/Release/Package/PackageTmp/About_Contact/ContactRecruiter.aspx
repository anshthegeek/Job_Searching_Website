<%@ Page Title="" Language="C#" MasterPageFile="~/About_Contact/Contact.Master" AutoEventWireup="true" CodeBehind="ContactRecruiter.aspx.cs" Inherits="Master_Page_loginRegister.About_Contact.ContactRecruiter" %>
  ...
  <section id="header" class="header1">
        ...
        <div>
            <ul id="navbar" class="navv"  style="position:relative; left:33px">
                <li class="last"><a href="../JobRecuritor/HomeJobRecruiter.aspx">Profile</a></li>
                <li class="last"><a href="../JobRecuritor/JobPostWeb.aspx">Job Post</a></li>
                <li class="last"><a href="../JobRecuritor/changepasswordJobRecruiter.aspx">Change Password</></li>
                <li><a href="AboutRecruiter.aspx">About</a></li>
                <li><a href="ContactRecruiter.aspx" class="active">Contact </a></li>
