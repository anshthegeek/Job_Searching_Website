<%@ Page Title="" Language="C#" MasterPageFile="~/About_Contact/About.Master" AutoEventWireup="true" CodeBehind="AboutRecruiter.aspx.cs" Inherits="Master_Page_loginRegister.About_Contact.AboutRecruiter" %>
  ...
  <section id="header" class="header1">
        ...
        <div>
            <ul id="navbar" class="navv"  style="position:relative; left:-13px">
                ...
                <li class="last"><a href="../JobRecuritor/changepasswordJobRecruiter.aspx">Change Password</a></li>
                <li><a href="AboutRecruiter.aspx" class="active">About</a></li>
                <li><a href="ContactRecruiter.aspx">Contact </a></li>
