<%@ Page Title="" Language="C#" MasterPageFile="~/JobSeeker/JobSeeker.Master" AutoEventWireup="true" CodeBehind="changepasswordJobSeeker.aspx.cs" Inherits="Master_Page_loginRegister.JobSeeker.changepasswordJobSeeker" %>
 ...
 <section id="header" class="header1"  style="position:relative; left:3px;width:1534px" >
        ...
        <div>
            <ul id="navbar" class="navv"  style="position:relative; left:3px">
                <li class="last"><a href="HomJobSeeker.aspx">Profile</a></li>
                <li class="last"><a href="../About_Contact/SearchLocation_2.aspx">Jobs</a></li>
                <li class="last"><a href="changepasswordJobSeeker.aspx" class="active">Change Password</></li>
      ...
      <p style="position:relative;top:-9px;left:151px"><asp:TextBox ID="txtnewpassword" runat="server" Width="278px" CssClass="input100" placeholder="New Password" required="required"/></p>
       ...
       <p style="position:relative;top:-6px;left:153px"><asp:TextBox ID="txtconfirm" runat="server" CssClass="input100" Width="278px" placeholder="Confirm Password" required="required"/></p>
                    ...
                    <div class="container-login100-form-btn">
                     <p style="position:relative;top:3px;left:156px"><asp:Button ID="btnchange" runat="server" CssClass="login100-form-btn" Width="278px" Text="Change" OnClick="btnchange_Click2" ></asp:Button></p>    
